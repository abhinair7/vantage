...
export const CUSTOMER_PIPELINE: CustomerStep[] = [
  {
    ...
    sublabel: "Parsing decision intent, site type, and time frame",
    touch: "LLM",
  },
  {
    id: "locate",
    label: "Locating the area",
    sublabel: "Resolving the prompt to a canonical map object",
    touch: "DETRM",
  },
  {
    id: "pull",
    label: "Pulling public sources",
    sublabel: "OpenStreetMap, Wikidata, and public background context",
    touch: "DETRM",
  },
  {
    id: "measure",
    label: "Sizing the operating context",
    sublabel: "Nearby assets, operating signals, and commercial relevance",
    touch: "DETRM",
  },
  {
    id: "verify",
    label: "Testing confidence",
    sublabel: "Checking source diversity and limiting unsupported claims",
    touch: "DETRM",
  },
  {
    id: "compose",
    label: "Writing the brief",
    sublabel: "Turning grounded evidence into a decision-ready readout",
    touch: "LLM",
  },
];
