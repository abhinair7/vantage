...
export const CUSTOMER_PIPELINE: CustomerStep[] = [
  ...
  },
  {
    ...
    sublabel: "Open map context, place metadata, linked references",
    touch: "DETRM",
  },
  {
    id: "measure",
    label: "Sizing the operating context",
    sublabel: "Nearby infrastructure, asset type, decision relevance",
    touch: "DETRM",
  },
  {
    id: "verify",
    label: "Testing confidence",
    sublabel: "Cross-checking sources and limiting unsupported claims",
    touch: "DETRM",
  },
  {
    id: "compose",
    label: "Composing the brief",
    sublabel: "Turning evidence into a decision-ready readout",
    touch: "LLM",
  },
];
